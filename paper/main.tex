...
This work made substantial use of AI tools (Anthropic Claude) under the
author's direction, including simulator and experiment implementation,
literature search, and manuscript drafting and editing; an AI-assisted
adversarial review was additionally used to stress-test the methodology
prior to submission. The author defined the research questions, made the
design decisions, verified the analyses, and takes full responsibility
for the content.
