...
([XNETS]); correlation-aware results average three training seeds
...
state; measured accuracy is invariant to lane count ([LANEINV] at
50/100/200/500 lanes for the same operating point and warm-up),
confirming the protocol. Every result file records its git revision;
