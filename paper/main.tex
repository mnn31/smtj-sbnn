...
CPU in hours. The project repository contains the code, configurations, and
per-run records and will be public on publication.
...
This work was developed with AI assistance under the author's
direction: simulator and experiment implementation, and preparation of
the manuscript including drafting, revision, and its related-work
survey. An AI-assisted adversarial review was used to stress-test the
